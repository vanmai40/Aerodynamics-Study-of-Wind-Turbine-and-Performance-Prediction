# -*- coding: utf-8 -*-
"""
Created on Tue Jan  2 00:50:34 2018
...
TSR_range=np.linspace(3.6, 4, 1).tolist()
z_range=np.linspace(0, 0.999, 8).tolist()
t7c=0.21
a0=1.8*pi*(1+0.8*t7c)
'########################################################'
'###### tính toán upwind ###########'
...
p1.asterisk(Tta,CN,legend='D-Multiple Streamtube',line_color=mau,fill_color=None,alpha=3,size=13)
p1.line(Tta,CN,legend='D-Multiple Streamtube', line_color=mau,alpha=3,line_width=1)
